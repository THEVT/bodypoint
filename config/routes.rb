Bodypoint::Application.routes.draw do
	...
	match '/success_stories_landing_page', to: 'pages#success_stories_landing_page'
	match '/aditya_story', to: 'pages#aditya_story'
	match '/alin_story', to: 'pages#alin_story'
	match '/barry_long_story', to: 'pages#barry_long_story'
	match '/hal_story', to: 'pages#hal_story'
	match '/todd_stabelfeldt_story', to: 'pages#todd_stabelfeldt_story'
